      ...
      <div className="flex items-center justify-between mb-8">
        <div>
          <h1 className="text-2xl font-bold text-white">
            Good morning, Bonface! 👋
          </h1>
          <p className="text-gray-500 mt-1">
            Here is what is happening at your dealership today.
          </p>
        </div>
        <div className="flex items-center gap-2 bg-brand-500/10 border border-brand-500/30 rounded-lg px-4 py-2">
          <Zap size={16} className="text-brand-400" />
          <span className="text-sm font-semibold text-brand-400">AI Active</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-dark-300 border border-dark-100 rounded-xl overflow-hidden">
          <div className="flex items-center justify-between px-6 py-4 border-b border-dark-100">
            ...
            <a href="/dashboard/leads" className="text-sm text-brand-400 hover:text-brand-300 font-medium">
              View All →
            </a>
          </div>
          <div className="divide-y divide-dark-100">
            {RECENT_LEADS.map((lead) => (
              <div key={lead.id} className="flex items-center justify-between px-6 py-4 hover:bg-dark-200 transition-colors">
                ...
                <div className="flex items-center gap-2">
                  <span className={`px-2 py-0.5 rounded-full text-xs font-semibold ${SOURCE_COLORS[lead.source]}`}>
                    {lead.source}
                  </span>
        ...
        <div className="bg-dark-300 border border-dark-100 rounded-xl overflow-hidden">
          ...
          <div className="px-4 pb-4">
            <div className="flex items-center justify-between p-3 rounded-xl bg-brand-500/10 border border-brand-500/20">
              <div>
                <p className="text-xs font-bold text-brand-300">AI Working</p>
